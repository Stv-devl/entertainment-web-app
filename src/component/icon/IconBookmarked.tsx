...
/**
 * Renders a bookmark icon with dynamic color based on selection state.
 ...
 * @returns {JSX.Element} The bookmark icon component.
 */
const IconBookmarked: React.FC<IconBookmarkedProps> = ({
  isSelected = false,
